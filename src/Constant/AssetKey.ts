export const audioObj = {
    COIN: { key: 'coin', path: 'assets\\audio\\coin.mp3' },
    DEATH: { key: 'death', path: 'assets\\audio\\death.mp3' },
    GAME_OVER: { key: 'game-over', path: 'assets\\audio\\gameOver.mp3' },
    HERE_WE_GO: { key: 'here-we-go', path: 'assets\\audio\\hereWeGo.mp3' },
    INTRO: { key: 'intro', path: 'assets\\audio\\intro.mp3' },
    JUMP_HIGH: { key: 'jump-high', path: 'assets\\audio\\jumpHigh.mp3' },
    JUMP_LOW: { key: 'jump-low', path: 'assets\\audio\\jumpLow.mp3' },
    POWER_UP: { key: 'power-up', path: 'assets\\audio\\powerUp.mp3' },
    THEME: { key: 'theme', path: 'assets\\audio\\theme.mp3' },
