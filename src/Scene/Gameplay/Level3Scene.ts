...
export class Level3Scene extends Phaser.Scene {
    ...
    preload() {
        this.load.tilemapTiledJSON('level-3', 'assets\\level\\Level3.json')
    ...
    private createMap(): void {
        this.levelMap = this.make.tilemap({ key: 'level-3', tileWidth: 16, tileHeight: 16 })
    ...
    private setupPlatformLayer(): void {
        if (this.platform !== undefined) {
            ...
            this.platform.setCollision([6, 7, 8, 9, 10, 28, 29, 30, 31, 32, 50, 51, 52])
